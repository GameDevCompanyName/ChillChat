...
public class Message extends VBox {
    ...
    private void setGlowEffect() {
        ...
        glowUp.getKeyFrames().add(new KeyFrame(Duration.seconds(0.1), new KeyValue(glow.levelProperty(), 1.0)));
        ...
        glowDown.getKeyFrames().add(new KeyFrame(Duration.seconds(0.1), new KeyValue(glow.levelProperty(), 0.0)));
